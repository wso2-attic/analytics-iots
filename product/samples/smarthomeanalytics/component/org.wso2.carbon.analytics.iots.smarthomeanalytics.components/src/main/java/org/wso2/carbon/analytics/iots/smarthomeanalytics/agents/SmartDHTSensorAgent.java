...
public class SmartDHTSensorAgent implements Runnable {
    ...
    public SmartDHTSensorAgent(DataPublisher dataPublisher, CountDownLatch countDownLatch, String sensorDataResourcePath
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                Object[] payLoad = new Object[]{Long.valueOf(sensorReading[1]), Double.valueOf(sensorReading[2])
                        , Double.valueOf(sensorReading[3])};
