...
public class HousesInformationAgent implements Runnable {
    ...
    public HousesInformationAgent(DataPublisher dataPublisher, CountDownLatch countDownLatch, String sensorDataResource
            , String streamDefinition, int sensorDataPushInterval) {
    ...
    public void run() {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                Object[] payLoad = new Object[]{sensorReading[0], sensorReading[1], sensorReading[2], sensorReading[3]};
