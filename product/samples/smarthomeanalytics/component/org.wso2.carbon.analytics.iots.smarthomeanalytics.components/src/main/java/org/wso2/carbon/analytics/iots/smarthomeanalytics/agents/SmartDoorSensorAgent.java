...
public class SmartDoorSensorAgent implements Runnable {
    ...
    public SmartDoorSensorAgent(DataPublisher dataPublisher, CountDownLatch countDownLatch
    ...
    public void run() {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                Object[] payLoad = new Object[]{Long.valueOf(sensorReading[1]), Integer.valueOf(sensorReading[2])};
