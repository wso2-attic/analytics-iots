...
public class SmartSwitchSensorAgent implements Runnable {
    ...
    public SmartSwitchSensorAgent(DataPublisher dataPublisher, CountDownLatch countDownLatch
    ...
    public void run() {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                String[] aLog = scanner.nextLine().split(",");
                String[] metaInfo = aLog[0].split(":");
                ...
                Object[] payLoad = new Object[]{Long.valueOf(aLog[1]), Double.valueOf(aLog[2])
                        , Double.valueOf(aLog[3]).intValue(), Double.valueOf(aLog[4])};
