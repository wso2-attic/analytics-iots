...
package org.wso2.carbon.analytics.iots.smarthomeanalytics.agents;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.wso2.carbon.analytics.iots.smarthomeanalytics.SensorAgentService;
import org.wso2.carbon.analytics.iots.smarthomeanalytics.constants.Constants;
...
public class SensorMetaInformationAgent implements Runnable {
    ...
    public SensorMetaInformationAgent(DataPublisher dataPublisher, CountDownLatch countDownLatch
    ...
    public void run() {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                Object[] metaData = new Object[]{metaInfo[0]
                        , metaInfo[0] + "-" + metaInfo[1], metaInfo[0] + "-" + metaInfo[1]
                        , metaInfo[0] + "-" + metaInfo[1] + "-" + metaInfo[2] + "-" + metaInfo[3], metaInfo[3]};
                Object[] payLoad = new Object[]{sensorReading[1], sensorReading[2], sensorReading[3]};
