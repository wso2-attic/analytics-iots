...
public class SmartMotionDetectorSensorAgent implements Runnable {
    ...
    public SmartMotionDetectorSensorAgent(DataPublisher dataPublisher, CountDownLatch countDownLatch
