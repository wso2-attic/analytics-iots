...
(function() {
    ...
    var PROVIDER_NAME = 'motorRally';

    var TYPE = "type";
    var TABLE_NAME = "tableName";
    var DATA_RANGE = "dataRange";
    var DATA_ORDER = "dataOrder";
    ...
    var motorRallyAnalyticsDataRanges = require("motorRallyAnalyticsDataRanges.js");
    ...
    getConfig = function() {
        ...
        configs.forEach(function(config) {
            ...
            if (config.fieldName === DATA_RANGE) {
                config.valueSet = [motorRallyAnalyticsDataRanges.HOURLY, motorRallyAnalyticsDataRanges.DAILY,
                                    motorRallyAnalyticsDataRanges.WEEKLY, motorRallyAnalyticsDataRanges.MONTHLY,
                                    motorRallyAnalyticsDataRanges.YEARLY, motorRallyAnalyticsDataRanges.ALL];
            }
            if (config.fieldName === DATA_ORDER) {
                config.valueSet = [motorRallyAnalyticsDataRanges.NONE, motorRallyAnalyticsDataRanges.ORDER_ASEC,
                                    motorRallyAnalyticsDataRanges.ORDER_DESC];
            }
        });
        return formConfig;
    };
