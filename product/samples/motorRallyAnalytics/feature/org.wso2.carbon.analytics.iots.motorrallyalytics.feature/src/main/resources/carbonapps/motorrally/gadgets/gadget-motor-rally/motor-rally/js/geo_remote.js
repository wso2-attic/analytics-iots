...
function addTileUrl() {
    ...
    var serverUrl = "/portal/store/carbon.super/fs/gadget/motor-rally/controllers/tile_servers.jag";
...
function getTileServers() {
    $.getJSON("/portal/store/carbon.super/fs/gadget/motor-rally/controllers/tile_servers.jag?serverId=all", function (data) {
...
function addWmsEndPoint() {
    ...
    if(validated){
        ...
        var serverUrl = "/portal/store/carbon.super/fs/gadget/motor-rally/controllers/wms_endpoints.jag";
        // TODO: If failure happens notify user about the error message
        $.post(serverUrl, data, function (response) {
            $.UIkit.notify({
                message: '<span style="color: dodgerblue">' + response + '</span>',
...
function loadWms() {
    ...
    $.getJSON("/portal/store/carbon.super/fs/gadget/motor-rally/controllers/wms_endpoints.jag?serverId=all", function (data) {
        $.each(data, function (key, val) {
...
function setSpeedAlert() {
    ...
    if(speedAlertValue == null || speedAlertValue === undefined || speedAlertValue == ""){
        ...
        $.post('/portal/store/carbon.super/fs/gadget/motor-rally/controllers/set_alerts.jag', data, function (response) {
            $.UIkit.notify({
        ...
        //$.post('/portal/controllers/apis/motor-rally/set_alerts.jag', data, function (response) {
        //    $.UIkit.notify({
        //        message: '<span style="color: dodgerblue">' + response.status + '</span><br>' + response.message,
        //        status: (response.status == 'success' ? 'success' : 'danger'),
        //        timeout: 3000,
...
function removeGeoFence(geoFenceElement,id) {
    ...
    $.post('/portal/store/carbon.super/fs/gadget/motor-rally/controllers/remove_alerts.jag', data, function (response) {
        $.UIkit.notify({
            message: '<span style="color: dodgerblue">' + response.status + '</span><br>' + response.message,
            status: (response.status == 'success' ? 'success' : 'danger'),
            timeout: 3000,
...
function getAlertsHistory(objectId) {
    $.getJSON("/portal/store/carbon.super/fs/gadget/motor-rally/controllers/get_alerts_history.jag?objectId=" + objectId, function (data) {
