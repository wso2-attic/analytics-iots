...
var views = [{
    ...
    datasource : "",
    type: "batch",
    time_from:1462452034198,
    time_to:1462455634198,
    ...
    columns: [
        ...
        {"name": "startingTime", "label": "Time", "type": "time"}
    ],
    domain: "carbon.super",
    ...
    subscriptions: [{
        ...
        callback: function(topic, data, subscriberData) {
            console.log("message from date picker...");
        }
    }],
    data: function() {
...
gadgets.HubSettings.onConnect = function () {
    ...
    gadgets.Hub.subscribe('subscriber', function (topic, data, subscriberData) {
        ...
        console.log("Time from:------>>" + data.timeFrom +" time to:----->>"+ data.timeTo);
        mainHandler.executeDataFetchForGadget(data.timeFrom, data.timeTo, views[0].params,views[0].type,columns, views[0].context, function(dataSet){
